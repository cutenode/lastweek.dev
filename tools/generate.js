...
async function markdown (org) {
  console.log(org)
  const organization = org // change this if you want to use a different organization
  ...
  fs.writeFile(path.resolve(`./reports/${org}/${dates.start}.md`), retro)
}
